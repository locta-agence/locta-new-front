...
function TikTokIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 14 16" fill="none" style={{ width: "14px", height: "16px", flexShrink: 0 }}>
...
const slides = [
  {
    icon: <InstagramIcon />,
    handle: "@LO.CTA",
    bg: "url(/images/img-21.png) lightgray center/cover no-repeat",
  },
  {
    icon: <TikTokIcon />,
    handle: "LO.CTA",
    bg: "url(/images/134f8f4eb69029543e7dce8d7ab181d3b98565d6.jpg) lightgray center/cover no-repeat",
  },
  {
    icon: <LinkedInIcon />,
    handle: "LOCTA",
    bg: "url(/images/source_imgi_69_442171572_983153753516259_113050789989027832_n.jpg) lightgray center/cover no-repeat",
  },
];
